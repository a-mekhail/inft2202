...
let newUser = new userClass.User("Andrew", "Mekhail", "mekhaila", "andrew.mekhail@dcmail.ca", "MyPassword123$");
...
if ($("#btnRegSubmit")) {
    ...
    $("#btnRegSubmit").click(function (e) {
        ...
        const invalidUser = new userClass.User(
    ...
    console.log(`UserDetails: ${invalidUser.displayUser()}`)

    // validate first name
    $("#first-group").children(".errorMessage").html(formValidation.validateFirst(invalidUser.firstName));
    // validate last name
    $("#last-group").children(".errorMessage").html(formValidation.validateLast(invalidUser.lastName));
    // validate  username
    $("#username-group").children(".errorMessage").html(formValidation.validateUsername(invalidUser.username));
    // validate confirm password
    let error = formValidation.validatePassword(invalidUser.password, $("#inputPassword2").val());
...
let btnRegReset = $("#btnRegReset");
if (btnRegReset) {
    // bind a click event handlers
